...
export class RelatorioFinanceiroMensalComponent implements OnInit {
  ...
  updateSizes(): void {
    ...
    const titleContainer = document.getElementById('financialReportTitleContainer');
    ...
    if (!titleContainer || !datePicker || !titleWrapper) {
      throw new Error('One of the following HTMLElements does not exist: financialReportTitleContainer, financialReportTitleWrapper, financialReportDatePicker.');
    }
